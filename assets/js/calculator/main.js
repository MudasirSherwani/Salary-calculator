...
var calculate = {
	...
	mnet : function(val){ 
			...
			var horaireNet = mensuelNet / (_this.hparm )  * (100 / _this.tmptravail); // equivaut au 35 heure/semaine sur 1 mois
    ...
    mnetsrc : function(val, txsource){ 
			...
			var horaireNetSource = mensuelNetSource / (_this.hparm )  * (100 / _this.tmptravail); // equivaut au 35 heure/semaine sur 1 mois
