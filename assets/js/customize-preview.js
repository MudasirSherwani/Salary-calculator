...
(function () {
  ...
  wp.customize('background_color', (value) => {
    value.bind((to) => {
      const lum = twentytwentyoneGetHexLum(to);
      const isDark = lum < 127;
      const textColor = !isDark ? 'var(--global--color-dark-gray)' : 'var(--global--color-light-gray)';
      const tableColor = !isDark ? 'var(--global--color-light-gray)' : 'var(--global--color-dark-gray)';
      const stylesheetID = 'twentytwentyone-customizer-inline-styles';
      let stylesheet;
      let styles;
